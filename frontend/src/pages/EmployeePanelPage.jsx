...
const cardStyle = { padding: 16, borderRadius: 16, border: "1px solid var(--glass-border)", background: "rgba(255, 255, 255, 0.02)", marginBottom: 12, transition: "all 0.2s ease" };
...
const textAreaStyle = { width: "100%", minHeight: 88, resize: "vertical", padding: "10px 16px", borderRadius: 12, border: "1px solid var(--glass-border)", background: "rgba(0,0,0,0.2)", color: "var(--text-primary)", outline: "none", transition: "all 0.2s ease", backdropFilter: "blur(10px)" };
